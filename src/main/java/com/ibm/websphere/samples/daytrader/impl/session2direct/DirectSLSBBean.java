...
public class DirectSLSBBean implements TradeServices {
  ...
  @Override
  public OrderDataBean createOrderV2(AccountDataBean account, QuoteDataBean quote, HoldingDataBean holding,
      String orderType, double quantity) throws Exception {
    tradeDirect.setInSession(true);
    return tradeDirect.createOrderV2(account, quote, holding, orderType, quantity);
  }
...
public void orderCreated(OrderResponse order) {
	...
	tradeDirect.orderCreated(order);
}
}